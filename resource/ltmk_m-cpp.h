...
/*****************Definitions***************************/
extern "C" 
extern "C" int TmkOpen(void);
extern "C" void TmkClose(void);

extern "C" int tmkgetmaxn(void);
extern "C" int tmkconfig(int tmkNumber);
extern "C" int tmkdone(int tmkNumber);
extern "C" int tmkselect(int tmkNumber);
extern "C" int tmkselected(void);
extern "C" TMK_DATA_RET tmkgetmode(void);
extern "C" void tmksetcwbits(TMK_DATA tmkSetControl);
extern "C" void tmkclrcwbits(TMK_DATA tmkClrControl);
extern "C" TMK_DATA_RET tmkgetcwbits(void);
extern "C" int tmkwaitevents(int maskEvents, int fWait);
extern "C" void tmkgetevd(TTmkEventData *pEvD);

extern "C" int bcreset(void);
extern "C" int bcdefirqmode(TMK_DATA bcIrqMode);
extern "C" TMK_DATA_RET bcgetirqmode(void);
extern "C" TMK_DATA_RET bcgetmaxbase(void);
extern "C" int bcdefbase(TMK_DATA bcBasePC);
extern "C" TMK_DATA_RET bcgetbase(void);
extern "C" void bcputw(TMK_DATA bcAddr, TMK_DATA bcData);
extern "C" TMK_DATA_RET bcgetw(TMK_DATA bcAddr);
extern "C" DWORD bcgetansw(TMK_DATA bcCtrlCode);
extern "C" void bcputblk(TMK_DATA bcAddr, void *pcBuffer, TMK_DATA cwLength);
extern "C" void bcgetblk(TMK_DATA bcAddr, void *pcBuffer, TMK_DATA cwLength);
extern "C" int bcdefbus(TMK_DATA bcBus);
extern "C" TMK_DATA_RET bcgetbus(void);
extern "C" int bcstart(TMK_DATA bcBase, TMK_DATA bcCtrlCode);
extern "C" int bcstartx(TMK_DATA bcBase, TMK_DATA bcCtrlCode);
extern "C" int bcdeflink(TMK_DATA bcBase, TMK_DATA bcCtrlCode);
extern "C" DWORD bcgetlink(void);
extern "C" TMK_DATA_RET bcstop(void);
extern "C" DWORD bcgetstate(void);

extern "C" int rtreset(void);
extern "C" int rtdefirqmode(TMK_DATA rtIrqMode);
extern "C" TMK_DATA_RET rtgetirqmode(void);
extern "C" int rtdefmode(TMK_DATA rtMode);
extern "C" TMK_DATA_RET rtgetmode(void);
extern "C" TMK_DATA_RET rtgetmaxpage(void);
extern "C" int rtdefpage(TMK_DATA rtPage);
extern "C" TMK_DATA_RET rtgetpage(void);
extern "C" int rtdefpagepc(TMK_DATA rtPagePC);
extern "C" int rtdefpagebus(TMK_DATA rtPageBus);
extern "C" TMK_DATA_RET rtgetpagepc(void);
extern "C" TMK_DATA_RET rtgetpagebus(void);
extern "C" int rtdefaddress(TMK_DATA rtAddress);
extern "C" TMK_DATA_RET rtgetaddress(void);
extern "C" void rtdefsubaddr(TMK_DATA rtDir, TMK_DATA rtSubAddr);
extern "C" TMK_DATA_RET rtgetsubaddr(void);
extern "C" void rtputw(TMK_DATA rtAddr, TMK_DATA rtData);
extern "C" TMK_DATA_RET rtgetw(TMK_DATA rtAddr);
extern "C" void rtputblk(TMK_DATA rtAddr, void *pcBuffer, TMK_DATA cwLength);
extern "C" void rtgetblk(TMK_DATA rtAddr, void *pcBuffer, TMK_DATA cwLength);
extern "C" void rtsetanswbits(TMK_DATA rtSetControl);
extern "C" void rtclranswbits(TMK_DATA rtClrControl);
extern "C" TMK_DATA_RET rtgetanswbits(void);
extern "C" void rtgetflags(void *pcBuffer, TMK_DATA rtDir, TMK_DATA rtFlagMin, TMK_DATA rtFlagMax);
extern "C" void rtputflags(void *pcBuffer, TMK_DATA rtDir, TMK_DATA rtFlagMin, TMK_DATA rtFlagMax);
extern "C" void rtsetflag(void);
extern "C" void rtclrflag(void);
extern "C" TMK_DATA_RET rtgetflag(TMK_DATA rtDir, TMK_DATA rtSubAddr);
extern "C" TMK_DATA_RET rtgetstate(void);
extern "C" TMK_DATA_RET rtbusy(void);
extern "C" void rtlock(TMK_DATA rtDir, TMK_DATA rtSubAddr);
extern "C" void rtunlock(void);
extern "C" TMK_DATA_RET rtgetcmddata(TMK_DATA rtBusCommand);
extern "C" void rtputcmddata(TMK_DATA rtBusCommand, TMK_DATA rtData);

extern "C" int mtreset(void);
...
extern "C" TMK_DATA_RET mtgetsw(void);
...
extern "C" TMK_DATA_RET rtenable(TMK_DATA rtEnable);
#ifdef _TMK1553B_MRT
extern "C" int mrtgetmaxn(void);
extern "C" DWORD mrtconfig(int tmkNumber);
extern "C" int mrtselected(void);
extern "C" TMK_DATA_RET mrtgetstate(void);
extern "C" void mrtdefbrcsubaddr0(void);
extern "C" int mrtreset(void);
#endif //def_TMK1553B_MRT

extern "C" TMK_DATA_RET tmktimer(TMK_DATA tmkTimerCtrl);
extern "C" DWORD tmkgettimer(void);
extern "C" TMK_DATA_RET tmkgettimerl(void);
extern "C" DWORD bcgetmsgtime(void);
#define mtgetmsgtime bcgetmsgtime
extern "C" DWORD rtgetmsgtime(void);

extern "C" TMK_DATA_RET tmkgethwver(void);

extern "C" DWORD tmkgetevtime(void);
extern "C" TMK_DATA_RET tmkswtimer(TMK_DATA tmkSwTimerCtrl);
extern "C" DWORD tmkgetswtimer(void);

extern "C" TMK_DATA_RET tmktimeout(TMK_DATA tmkTimeOut);

#ifdef _TMK1553B_MRT
extern "C" int mrtdefbrcpage(TMK_DATA rtPage);
extern "C" TMK_DATA_RET mrtgetbrcpage(void);
#endif //def_TMK1553B_MRT
